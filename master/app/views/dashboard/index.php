    ...
    <div class="col-lg-4">
        <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="?page=clients" class="btn btn-sm btn-akti-outline" style="font-size:12px;">Ver todos</a>
            </div>
            <div class="card-body">
            ...
            <div class="card-body py-4">
                <div class="row text-center">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <a href="?page=plans&action=create" class="text-decoration-none">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <a href="?page=clients&action=create" class="text-decoration-none">
