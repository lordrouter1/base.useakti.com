...
$topbarActions = '<a href="?page=plans&action=create" class="btn btn-akti"><i class="fas fa-plus me-2"></i>Novo Plano</a>';
    ...
    <div class="card">
        <div class="card-body">
            <div class="empty-state">
                ...
                <a href="?page=plans&action=create" class="btn btn-akti mt-2">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="plan-card <?= $index === 1 ? 'featured' : '' ?> <?= !$plan['is_active'] ? 'opacity-50' : '' ?>">
                    ...
                    <div class="d-flex gap-2">
                        <a href="?page=plans&action=edit&id=<?= $plan['id'] ?>" class="btn btn-akti-outline flex-fill" style="font-size:13px;">
                ...
                <tbody>
                    <?php foreach ($plans as $plan): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?page=plans&action=edit&id=<?= $plan['id'] ?>" class="btn-action btn-edit" title="Editar">
...
function deletePlan(id, name, clientCount) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = `?page=plans&action=delete&id=${id}`;
        }
    });
}
</script>
