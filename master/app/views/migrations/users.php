...
$topbarActions = '<a href="?page=migrations" class="btn btn-akti-outline"><i class="fas fa-arrow-left me-2"></i>Migrações</a>';
    ...
    $(document).on('click', '.btn-toggle-user', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post('?page=migrations&action=toggleUser', {db_name: dbName, user_id: userId}, function(data) {
                    if (data.success) {
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <div class="card" style="position:sticky; top:80px;">
            <div class="card-header d-flex align-items-center gap-2" style="background: linear-gradient(135deg, var(--akti-primary), var(--akti-primary-light)); color:#fff;">
