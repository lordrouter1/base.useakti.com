            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control form-control-lg" id="name" name="name" required placeholder="Ex: Cartão de Visita, Banner, Adesivo..." autofocus aria-describedby="name_help">
                        <div class="form-text" id="name_help"><i class="fas fa-info-circle me-1"></i>Nome principal que identifica o produto.</div>
                    </div>
                    <div class="col-md-4">
                        <label for="sku" class="form-label fw-bold">SKU</label>
                        <input type="text" class="form-control form-control-lg" id="sku" name="sku" placeholder="Ex: CART-VIS-001" aria-describedby="sku_help">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="number" step="0.01" class="form-control" id="price" name="price" required placeholder="0.00" aria-describedby="price_help">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" id="use_stock_control" name="use_stock_control" value="1" aria-describedby="stock_help">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnInheritSectors) {
        btnInheritSectors.addEventListener('click', function() {
            ...
            Swal.fire({ icon: 'success', title: 'Setores importados!', text: sectors.length + ' setor(es) importado(s).', timer: 2000, showConfirmButton: false });
        });
    }
