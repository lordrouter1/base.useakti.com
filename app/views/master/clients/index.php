...
$topbarActions = '<a href="?page=master_clients&action=create" class="btn btn-akti"><i class="fas fa-plus me-2"></i>Novo Cliente</a>';
...
function toggleClient(id, name, isActive) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = '?page=master_clients&action=toggleActive&id=' + id;
        }
    });
}
    ...
    <div class="card">
        <div class="card-body">
            <div class="empty-state">
                ...
                <a href="?page=master_clients&action=create" class="btn btn-akti mt-2">
                        ...
                        <tr data-status="<?= $client['is_active'] ? 'active' : 'inactive' ?>" 
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="?page=master_clients&action=edit&id=<?= $client['id'] ?>" class="btn-action btn-edit" title="Editar">
    ...
    <div class="modal fade" id="deleteClientModal" tabindex="-1" aria-labelledby="deleteClientModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border:none; border-radius:16px; overflow:hidden;">
                ...
                <form action="?page=master_clients&action=delete" method="POST" id="deleteClientForm">
                    <?= csrf_field() ?>
