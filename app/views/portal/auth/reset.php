<?php
/**
 * Portal do Cliente — Redefinir Senha
 *
...
<div class="portal-auth-container">
    <div class="portal-auth-card">
        ...
        <div class="portal-auth-header">
            ...
            <?php endif; ?>
            <h1 class="portal-auth-title"><?= __p('reset_title') ?></h1>
        </div>
        ...
        <form method="POST" action="?page=portal&action=resetPassword&token=<?= eAttr($token) ?>" class="portal-auth-form">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                <div class="portal-input-group">
                    ...
                    <input type="password"
                           ...
                           placeholder="<?= __p('reset_password') ?>"
                           required
            ...
            <div class="mb-3">
                <div class="portal-input-group">
                    ...
                    <input type="password"
                           ...
                           class="form-control portal-input"
                           placeholder="<?= __p('reset_password_confirm') ?>"
                           required
                           autocomplete="new-password"
                           minlength="8">
                </div>
