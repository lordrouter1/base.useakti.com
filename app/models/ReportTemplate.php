        ...
        return [
            'orders' => [
                ...
                'columns' => [
                    ...
                    'total_amount'  => ['label' => 'Valor Total',         'description' => 'Soma de todos os itens do pedido (R$).'],
                    ...
                    'deadline'      => ['label' => 'Previsão de Entrega', 'description' => 'Data prevista para entrega ao cliente.'],
                ],
            ],
            'customers' => [
                'label' => 'Clientes',
            ...
            'products' => [
                ...
                'columns' => [
                    ...
                    'stock_quantity' => ['label' => 'Estoque',   'description' => 'Quantidade em estoque atual.'],
            ...
            'financial' => [
                ...
                'columns' => [
                    ...
                    'transaction_date' => ['label' => 'Data',      'description' => 'Data de competência da transação.'],
